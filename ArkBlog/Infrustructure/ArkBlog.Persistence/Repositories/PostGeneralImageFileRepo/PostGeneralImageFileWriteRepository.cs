...
{
    public class PostGeneralImageFileWriteRepository : WriteRepository<PostGeneralImageFile>, IPostGeneralImageFileWriteRepository
    {
        public PostGeneralImageFileWriteRepository(ArkBlogDbContext context) : base(context)
        {
        }
    }
}
